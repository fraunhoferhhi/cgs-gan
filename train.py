...
@click.option("--img_snap",         help="How often to save snapshots",             type=int,   default=100)
@click.option("--network_snap",     help="How often to save network pkl",           type=int,   default=100)
